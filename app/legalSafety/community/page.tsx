...
export default function CommunityGuidelinesPage() {
  const { communityGuidelines, loading, error } = useLegalData();

  if (loading) return <LoadingSkeleton />;
  if (error || !communityGuidelines) return <ErrorState message={error || "Community guidelines not available."} />;

  const { content, effectiveFrom, publishedAt } = communityGuidelines;
