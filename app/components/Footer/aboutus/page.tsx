              ...
              <ul className="mt-3">
                {MORE_LINKS.map((l) => (
                  <li key={l.label}>
                    <Link
                      href={l.href}
                      className="flex items-center justify-between border-b py-3.5 text-[14px] transition-colors hover:text-[#C21559]"
              ...
              <ul className="mt-3 space-y-2">
                {TOC.map((t) => (
                  <li key={t.id}>
                    <a
                      href={`#${t.id}`}
                      className="text-[13px] transition-colors hover:text-[#C21559]"
                      style={{ color: C.body }}
                    >
                      {t.label}
                    </a>
